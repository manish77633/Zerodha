  ...
  const WatchList = () => {
    // 1. openSellWindow ko bhi yahan extract karo
              ...
              return (
                <li key={id} className="relative flex justify-between items-center px-4 py-3 border-b border-gray-50 hover:bg-gray-50 cursor-pointer group transition-all duration-200">
                  ...
                  <div className="hidden group-hover:flex items-center bg-gray-50 gap-1 pl-4">
                    ...
                    {/* 2. SELL BUTTON - Yahan openSellWindow add kiya */}
                    <button 
                      onClick={() => openSellWindow(stock)}
                      className="bg-orange-500 cursor-pointer text-white p-1 rounded-sm hover:bg-orange-600 transition-colors"
                    >
